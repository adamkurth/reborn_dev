...
jungfrau4m = dict(pad_id='jungfrau4M',
                  geometry=jungfrau4m_pad_geometry_list(detector_distance=0.5))
...
runstats_config = dict(log_file=f"{config['results_directory']}/runstats/logs/",
                       checkpoint_file=f"{config['results_directory']}/runstats/checkpoints/",
...
def get_config(run_number=None):
