...
\emph{This note certainly has typos and errors that need to be corrected.  Please let me know if you find any.}
...
fields from a moving point charge were derived Griffiths, starting with Maxwell's equations
in vacuum:
\begin{align}
