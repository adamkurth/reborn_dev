...
#       simulators
        self.Tmol1 = thorn.ThornAgain(
            self.det.q_vecs,
            self.trimer1.xyz -
            self.t1_com,
            self.trimer1.Z)
        self.Tmol2 = thorn.ThornAgain(
            self.det.q_vecs,
            self.trimer2.xyz -
            self.t2_com,
            self.trimer2.Z)
...
#       simulate each lattice now
        Tlat1 = thorn.ThornAgain(self.det.q_vecs, self.rand_lat1)
        Tlat2 = thorn.ThornAgain(self.det.q_vecs, self.rand_lat2)
