...
from bornagain.target.crystal import get_pdb_file
...
simulator = CrystalSimulatorV1(pad_geometry=pads, beam=beam, crystal_structure=cryst, n_iterations=10,
