    ...
    with open(pdbFilePath) as pdbfile:
        ...
        for line in pdbfile:
            ...
            if line[:6] == 'ATOM  ' or line[:6] == "HETATM":
                ...
                #z = atoms.atomic_symbols_to_numbers(elements[atomIndex]) #xr.SymbolToAtomicNumber(elements[atomIndex])
                atomIndex += 1
...
def hermannMauguinToNumber(hm,hall=False):
    ...
    in PDB files to the space group number or the "Hall number" that is used by the 
    spglib module.
    '''
