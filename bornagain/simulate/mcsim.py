...
3. Update information printed to user throughout code.
...
"""
	...
	# TODO: Make these variables match new set of variables for function
	values = [pdb_file, crystal_size, photon_energy*keV, n_monte_carlo_iterations, shape_transform_model,
			  write_hdf5, write_geom, quiet, cromer_mann, random_rotation, beam_diameter, beam_spatial_profile,
			  ...
			  beam_divergence_fwhm/(8e-6/beam_diameter), num_patterns, water_radius, temperature,
			  shape_transform_model, fix_rot_seq, mosaic_domain_size_fwhm/mosaic_domain_size, crystal_size_fwhm/crystal_size,
			  write_crystal_sizes, expand_symm, wavelength_fwhm/wavelength, n_photons]

	names = ['pdb_file', 'crystal_size', 'photon_energy', 'iterations', 'lattice_transform',
			  'write_hdf5', 'write_geom', 'quiet', 'cromer_mann', 'no_rotation', 'beam_diameter', 'beam_spatial_profile',
			  ...
			  'beam_divergence', 'num_patterns', 'water_radius', 'temperature', 
			  'shape_transform','fix_rotation_sequence', 'mosaic_domain_size_fwhm','crystal_size_fwhm',
			  'write_crystal_sizes', 'expand_symmetry', 'wavelength_fwhm', 'n_photons']
