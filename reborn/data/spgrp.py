...
r"""
This module is a data container and should not be used externally.  The data should be
accessed using :func:`get_symmetry_operators_from_space_group
<reborn.target.crystal.get_symmetry_operators_from_space_group>`.

The data were taken from the `spglib <https://atztogo.github.io/spglib/>`_ package.  For example:
...
The following lists are defined below:
...
# These are the spacegroup numbers (1-230) corresponding to each Hall
# number (1-530)
_sgnum = [
    1,
    2,
