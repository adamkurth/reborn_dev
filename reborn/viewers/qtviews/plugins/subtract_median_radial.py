...
class Plugin():
    ...
    def action(self):
        ...
        t = time()
        profiler = reborn.detector.RadialProfiler(pad_geometry=padview.dataframe.get_pad_geometry(),
                                                       beam=padview.dataframe.get_beam())
        data = profiler.subtract_median_profile(padview.get_pad_display_data(),
